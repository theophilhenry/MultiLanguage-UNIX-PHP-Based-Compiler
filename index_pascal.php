...
$command2 = "time temp/compiled_pascal <soal/pascal.in> temp/result_pascal.out";
...
if ($result == "Accepted") {
    $process = proc_open('cmp temp/result_pascal.out soal/pascal.out', $descriptorspec, $pipes);
